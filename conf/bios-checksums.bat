...
:: Nintendo DS
    ...
    set bios[43].name=nds_bios_arm7.bin
    set bios[43].CRC32=
    set bios[43].MD5=
    set bios[43].desc="for DraStic: nds_bios7.bin, nds_bios9.bin & nds_firmware.bin"
    set bios[44].name=nds_bios_arm9.bin
    set bios[44].CRC32=
    set bios[44].MD5=
    set bios[44].desc="for DraStic: nds_bios7.bin, nds_bios9.bin & nds_firmware.bin"
    set bios[45].name=nds_firmware.bin
    set bios[45].CRC32=
    set bios[45].MD5=
    set bios[45].desc="for DraStic: nds_bios7.bin, nds_bios9.bin & nds_firmware.bin"
    set bios[43].name=bios7.bin
    set bios[43].CRC32=
    set bios[43].MD5=
    set bios[43].desc="lr-desmume can load BIOS file: bios7.bin, bios9.bin & firmware.bin"
    set bios[44].name=bios9.bin
    set bios[44].CRC32=
    set bios[44].MD5=
    set bios[44].desc="lr-desmume can load BIOS file: bios7.bin, bios9.bin & firmware.bin"
    set bios[45].name=firmware.bin
    set bios[45].CRC32=
    set bios[45].MD5=
    set bios[45].desc="lr-desmume can load BIOS file: bios7.bin, bios9.bin & firmware.bin"

:: Nintendo Entertainment System (NES)

    set bios[46].name=disksys.rom
    set bios[46].CRC32=0x5e607dcf
    set bios[46].MD5=ca30b50f880eb660a320674ed365ef7a
    set bios[46].desc="[BIOS] Family Computer Disk System (Japan) (Rev 1)"

    set bios[47].name=fdsbios.zip
    set bios[47].CRC32=
    set bios[47].MD5=
    set bios[47].desc="zipped file - [BIOS] Family Computer Disk System (Japan) (Rev 1)"

:: PC-8800

    set bios[46].name=N88.ROM
    set bios[46].CRC32=0xA0FC0473
    set bios[46].MD5=
    set bios[46].desc=""
    set bios[47].name=N88SUB.ROM
    set bios[47].CRC32=0x2158D307
    set bios[47].MD5=
    set bios[47].desc=""
    set bios[46].name=N88N.ROM
    set bios[46].CRC32=0x5e607dcf
    set bios[46].MD5=
    set bios[46].desc=""
    set bios[47].name=N88EXT0.ROM
    set bios[47].CRC32=0x710A63EC
    set bios[47].MD5=
    set bios[47].desc=""
    set bios[46].name=N88EXT1.ROM
    set bios[46].CRC32=0xC0BD2AA6
    set bios[46].MD5=
    set bios[46].desc=""
    set bios[47].name=N88EXT2.ROM
    set bios[47].CRC32=0xAF2B6EFA
    set bios[47].MD5=
    set bios[47].desc=""
    set bios[46].name=N88EXT3.ROM
    set bios[46].CRC32=0x7713C519
    set bios[46].MD5=
    set bios[46].desc=""
    set bios[47].name=N88KNJ1.ROM
    set bios[47].CRC32=0x6178BD43
    set bios[47].MD5=
    set bios[47].desc=""
    set bios[46].name=N88KNJ2.ROM
    set bios[46].CRC32=0x154803CC
    set bios[46].MD5=
    set bios[46].desc=""

:: PC-9800

    set bios[46].name=2608_BD.WAV
    set bios[46].CRC32=0xFCB60C01
    set bios[46].MD5=29AAD51CD243C8E449D311D14613F0B1
    set bios[46].desc="for the PC-9800"
    set bios[47].name=2608_HH.WAV
    set bios[47].CRC32=0x7D6D9C4E
    set bios[47].MD5=59A009EE444318BD57D99A19068731E4
    set bios[47].desc="for the PC-9800"
    set bios[46].name=2608_RIM.WAV
    set bios[46].CRC32=0x8518A388
    set bios[46].MD5=943290D1C5C6AE6295BD02BE4411C7C0
    set bios[46].desc="for the PC-9800"
    set bios[47].name=2608_SD.WAV
    set bios[47].CRC32=0xC977FDB8
    set bios[47].MD5=C99156118789B6CBA662C864EBADC62E
    set bios[47].desc="for the PC-9800"
    set bios[46].name=2608_TOM.WAV
    set bios[46].CRC32=0x5E8AB475
    set bios[46].MD5=C321A6835B26AD125B2EB78BE56394A4
    set bios[46].desc="for the PC-9800"
    set bios[47].name=2608_TOP.WAV
    set bios[47].CRC32=0xCEFA9F76
    set bios[47].MD5=9E73FF2345236EBE72F7A937E477F0BD
    set bios[47].desc="for the PC-9800"
    set bios[46].name=BIOS.ROM
    set bios[46].CRC32=0x76AFFD90
    set bios[46].MD5=E246140DEC5124C5E404869A84CAEFCE
    set bios[46].desc="for the PC-9800"
    set bios[47].name=FONT.ROM
    set bios[47].CRC32=0xCD6DFABE
    set bios[47].MD5=2AF6179D7DE4893EA0B705C00E9A98D6
    set bios[47].desc="for the PC-9800"
    set bios[46].name=SOUND.ROM
    set bios[46].CRC32=0xA21EF796
    set bios[46].MD5=CAF90F22197AED6F14C471C21E64658D
    set bios[46].desc="for the PC-9800"
    set bios[46].name=ITF.ROM
    set bios[46].CRC32=0x273E9E88
    set bios[46].MD5=E9FC3890963B12CF15D0A2EEA5815B72
    set bios[46].desc="for the PC-9800"
